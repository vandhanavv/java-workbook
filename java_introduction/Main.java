...
// out is standard output stream. The value of out is null, which is the command line - it prints the command line output by default. If you want to print output from file, then out = File.
